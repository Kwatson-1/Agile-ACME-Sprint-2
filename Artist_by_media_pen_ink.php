            ...
            <tbody>
                ...
                try {
                    ...
                    //$sql = "SELECT Painting_Data.Artist, Painting_Data.Media, Artist_Data.Thumbnail, Artist_Data.Lifespan FROM Painting_Data LEFT JOIN Artist_Data ON Painting_Data.Artist = Artist_Data.Artist WHERE Media = 'oil' ORDER BY Painting_Data.Artist";
                	  $sql = "SELECT Artist_Data.Artist, Painting_Data.Media, Artist_Data.Lifespan, Painting_Data.Media, Artist_Data.Thumbnail FROM Artist_Data INNER JOIN Painting_Data ON Artist_Data.Artist=Painting_Data.Artist WHERE Media ='pen-ink' GROUP BY Artist";
